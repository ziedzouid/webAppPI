...
// If is a admin or super admin we redirect to the backoffice area
        if (in_array('ROLE_PASSAGER', $rolesTab, true))
            $redirection = new RedirectResponse($this->router->generate('passenger_home'));
// otherwise, if is a commercial user we redirect to the crm area
        elseif (in_array('ROLE_CONDUCTEUR', $rolesTab, true))
            $redirection = new RedirectResponse($this->router->generate('conducteur_home'));
